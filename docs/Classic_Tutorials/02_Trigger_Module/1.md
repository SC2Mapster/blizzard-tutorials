...
If you would like to jump straight into this tutorial without having to go through the terrain tutorial, you can use the map that we made in that tutorial, located [[here](#finished-map)].


# Finished Map
Learn to use the Trigger Module by creating Triggers to handle victory, defeat, and scripted in-game events.

[Download the Trigger Module - finished product map file](./resources/Trigger-Module-finished-product.SC2Map)

[Download the Trigger Module - fleshed out terrain map file](./resources/Trigger-Module-fleshed-out-terrain.SC2Map)

[Download the Trigger Module - starting point map file](./resources/Trigger-Module-starting-point.SC2Map)
...
If you don't want to spend time decorating the rest of the map, you can use the map that we made as a starting point for this tutorial, located [here](./1.md/#finished-map).
